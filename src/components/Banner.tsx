    ...
    <section className="py-16 px-6">
      <div className="max-w-screen-lg mx-auto space-y-8">
        ...
        <div className="relative w-full h-64 sm:h-80 lg:h-96 bg-gray-200 rounded-lg overflow-hidden shadow-md">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-yellow-400 px-4 sm:px-8">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold">
              Discover Our New Collection
            </h3>
            {/* Paragraph hidden on mobile */}
            <p className="mt-2 text-base sm:text-lg sm:block hidden">
        ...
        <div className="relative w-full h-48 sm:h-60 lg:h-72 bg-gray-200 rounded-lg overflow-hidden shadow-md">
          ...
          />
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black opacity-40" />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-blue-300 px-4 sm:px-8">
