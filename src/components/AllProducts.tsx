...
const AllProducts: React.FC = () => {
  // Array of 30 product data, now wrapped in useMemo
  const products = useMemo(
    ...
    []
  ); // Empty dependency array, so it's only computed once
  ...
  }, [sortOption, products]); // Now, products is stable due to useMemo
